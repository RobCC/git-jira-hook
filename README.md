# Git Jira hook [![version](https://img.shields.io/npm/v/git-jira-hook?color=crimson&style=flat-square)](https://www.npmjs.com/package/git-jira-hook) ![](https://img.shields.io/librariesio/release/npm/git-jira-hook?style=flat-square)
